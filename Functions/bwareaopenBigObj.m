function bw2 = bwareaopenBigObj(varargin)
%% GB modified version of bwareaopen that uses the second input convention listed below
% In this modified function, the P (pix area size) is the maximum object
% size allowed and all other larger objects are removed. This is the
% opposite function of the original bwareaopen function.
